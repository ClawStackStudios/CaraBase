...
function PublicLanding() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4">
      <div className="max-w-md w-full bg-white rounded-2xl shadow-xl border-t-2 border-emerald-500 p-8 text-center">
        ...
        <h1 className="text-3xl font-bold text-slate-900 tracking-tight mb-2">CaraBase</h1>
        <p className="text-slate-500 mb-8">ClawStack Studios©™ Data Layer</p>
        ...
        <div className="space-y-4">
          ...
          <a href="/setup" className="block w-full py-3 bg-slate-100 text-slate-700 rounded-xl font-medium hover:bg-slate-200 transition">
            Hatch New Identity
          </a>
        </div>
      </div>
